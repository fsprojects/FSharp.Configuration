                        ...
                        try
                            ...
                            | Choice1Of2 sections ->
                                for section in sections do
                                    let sectionTy =
                                        ProvidedTypeDefinition(section.Name, Some typeof<obj>, hideObjectMethods = true)
                                    ...
                                    for setting in section.Settings do
                                        ...
                                        prop.AddXmlDoc(
                                            sprintf "Returns the value from %s from section %s with key %s" iniFileName section.Name setting.Key
                                        )
                            ...
                            let prop =
                                ProvidedProperty(name, typeof<string>, isStatic = true, getterCode = fun _ -> getValue)
